...
const LandingPage = () => {
  ...
  const features = [
    ...
    {
      icon: <FaMicrophone className="text-4xl text-cyan-400" />,
    ...
    <div className="min-h-screen bg-[#0a192f] relative overflow-hidden">
      ...
      <section className="container mx-auto px-4 py-20 relative z-10">
        ...
        >
          ...
          >
            <FaLeaf className="text-6xl text-cyan-400" />
          </motion.div>
          <h1 className="text-6xl font-bold text-cyan-400 mb-6 leading-tight">
          ...
          >
            <Link
              to="/register"
              className="inline-flex items-center bg-cyan-400 text-[#0a192f] px-8 py-4 rounded-full text-lg font-semibold hover:bg-cyan-300 transition-colors shadow-lg hover:shadow-xl"
            >
              Get Started
      ...
      <section className="py-16 relative z-10">
        <div className="container mx-auto px-4">
          <motion.div
            {...fadeInUp}
            className="max-w-3xl mx-auto text-center bg-[#112240]/80 backdrop-blur-sm p-12 rounded-2xl shadow-xl border border-cyan-400/20"
          >
            <h2 className="text-4xl font-bold text-cyan-400 mb-6">The Challenge</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                whileHover={{ y: -10 }}
                className="bg-[#112240]/80 backdrop-blur-sm p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-cyan-400/20"
              >
                <motion.div
      ...
      <section className="py-20 relative z-10">
        <div className="container mx-auto px-4 text-center">
          <motion.div
            {...fadeInUp}
            className="bg-[#112240]/80 backdrop-blur-sm text-white p-12 rounded-2xl shadow-2xl border border-cyan-400/20"
          >
            <h2 className="text-4xl font-bold text-cyan-400 mb-6">Ready to Make a Difference?</h2>
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            ...
            >
              <Link
                to="/register"
                className="inline-flex items-center bg-cyan-400 text-[#0a192f] px-8 py-4 rounded-full text-lg font-semibold hover:bg-cyan-300 transition-colors"
              >
                Sign Up Now
                <FaArrowRight className="ml-2" />
              </Link>
      ...
      {/* Footer */}
      <footer className="bg-[#112240]/80 backdrop-blur-sm text-white py-12 relative z-10">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <FaLeaf className="text-4xl text-cyan-400 mb-4" />
